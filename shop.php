                            ...
                            if (!empty($_GET['search-cate'])) { ?>
                                                    ...
                                                    <?php if (isset($_SESSION['lgUserID'])) { ?>
                                                        <?php if (empty($productModel->getWhishlistExist($_SESSION['lgUserID'], $product['id']))) { ?>
                                                            <div class="icon-whishlist">
                                                                <a href="shop.php?id=<?= md5($product['id'] . 'chuyen-de-web-2') ?>&<?php if (isset($searchCate)) ?>search-cate=<?php echo $searchCate ?>&<?php if (isset($_GET['submit'])) ?>submit=<?php echo $_GET['submit'] ?>&page=<?php echo $page ?>">
                                ...
                                ?>
                                        <div class="product_pagination">
                                            <div class="left_btn">
                                                <a href="shop.php?<?php if (isset($searchCate)) ?>search-cate=<?php echo $searchCate ?>&<?php if (isset($_GET['submit'])) ?>submit=<?php echo $_GET['submit'] ?>&page=<?php echo $i ?>">
                            ...
                            if (!empty($_GET['search'])) { ?>
                                                ...
                                                <div class="cake_feature_item">
                                                    <div class="cake_img">
                                                        ...
                                                        <?php if (isset($_SESSION['lgUserID'])) { ?>
                                                            <?php if (empty($productModel->getWhishlistExist($_SESSION['lgUserID'], $product['id']))) { ?>
                                                                <div class="icon-whishlist">
                                                                    <a href="shop.php?id=<?= md5($product['id'] . 'chuyen-de-web-2') ?>&<?php if (!empty($search)) ?>search=<?php echo $search ?>&<?php if (!empty($_GET['submit'])) ?>submit=<?php echo $_GET['submit'] ?>&page=<?php echo $page ?>">
                                                                        <i class="fa fa-heart" aria-hidden="true"></i>
                                                                    </a>
                                                                </div>
                                                        <?php }
                                ...
                                ?>
                                        <div class="product_pagination">
                                            ...
                                            <div class="right_btn">
                                                <a href="shop.php?<?php if (!empty($search)) ?>search=<?php echo $search ?>&<?php if (!empty($_GET['submit'])) ?>submit=<?php echo $_GET['submit'] ?>&page=<?php if ($page < $number_of_pages) echo $page + 1;
                                                                                                                                                                                                            else echo $number_of_pages ?>">
                                                    Sau <i class="lnr lnr-arrow-right"></i>
                                                </a>
                                            </div>
                                            ...
                                            <div class="cake_feature_item">
                                                <div class="cake_img">
                                                    ...
                                                    <?php if (isset($_SESSION['lgUserID'])) { ?>
                                                        <?php if (empty($productModel->getWhishlistExist($_SESSION['lgUserID'], $product['id']))) { ?>
                                                            <div class="icon-whishlist">
                                                                <a href="shop.php?id=<?= md5($product['id'] . 'chuyen-de-web-2') ?>&page=<?php echo $page ?>">
                                                                    <i class="fa fa-heart" aria-hidden="true"></i>
                                                                </a>
                                                            </div>
                                                    <?php }
