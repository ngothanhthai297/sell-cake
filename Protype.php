            ...
            <div class="row product_inner_row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="product_pagination">
                        <div class="left_btn">
                            <a
                                href="Protype.php?type_id=<?php echo $typeid; ?>&<?php if (!empty($searchCate)) ?>search-cate=<?php echo $searchCate ?>&<?php if (!empty($_GET['submit'])) ?>submit=<?php echo $_GET['submit'] ?>&page=<?php if ($page > 1) echo $page - 1;
                                                                                                                                                                                                                                                        else echo 1 ?>">
                        ...
                        <div class="right_btn">
                            <a
                                href="Protype.php?type_id=<?php echo $typeid; ?>&<?php if (!empty($searchCate)) ?>search-cate=<?php echo $searchCate ?>&<?php if (!empty($_GET['submit'])) ?>submit=<?php echo $_GET['submit'] ?>&page=<?php if ($page < $number_of_pages) echo $page + 1;
                    ...
                    <div class="product_pagination">
                        <div class="left_btn">
                            <a
                                href="Protype.php?type_id=<?php echo $typeid; ?>&page=<?php if ($page > 1) echo $page - 1;
                                                                                                        else echo 1 ?>">
                                <i class="lnr lnr-arrow-left"></i>Trước
                            </a>
                        </div>
                                ...
                                <ul class="pagination">
                                    ...
                                    <li class="page-item ">
                                        <a class="page-link <?php if (isset($_GET['page']) && $_GET['page'] == $i) {
                                            ...
                                            href="Protype.php?type_id=<?php echo $typeid; ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
                                    </li>
                        ...
                        <div class="right_btn">
                            <a
                                href="Protype.php?type_id=<?php echo $typeid; ?>&page=<?php if ($page < $number_of_pages) echo $page + 1;
                                                                                                        else echo $number_of_pages ?>">
                                Sau <i class="lnr lnr-arrow-right"></i>
                            </a>
                        </div>
